...
knitr::include_graphics("coastal_power_graphic.png")
```
...
```{r, echo=FALSE, message=FALSE}
knitr::include_graphics("wind_vs_time_by_season.png")
```

Here's the plotted turbine power curve:

```{r, echo=FALSE, message=FALSE}
knitr::include_graphics("turbine_power_curve.png")
```
...
```{r, echo=FALSE, message=FALSE}
knitr::include_graphics("weighted_average_power_and_wind.png")
```